	...
	return (function(t) {
			...
			t.exports = function(t) {
				...
				(t.attachEvent = function(t, i, r) {
					...
					(t.callEvent = function(t, i, n) {
						...
						return (
							e.ev_listen_all &&
								e.ev_listen_all.apply(n || this, [t].concat(i)),
				...
				o = (function() {
					...
					return (
						...
						(t.prototype.getNode = function() {
							return (
								this.$view.querySelector('gantt_layout_cell') || this.$view
							);
						}),
						...
						return (
							...
							n.forEach(t, function(t) {
								...
								i == t.key &&
									...
									(r += o.getHtmlOption({ innerHTML: t.label }, e));
							}),
			...
			t.exports = {
				...
				nextSiblingTarget: function(t, e, i) {
					...
					return (
						...
						(i.getParent(t) != n.targetParent ||
							n.targetIndex < i.getBranchIndex(t)) &&
							(n.targetIndex += 1),
						n
					);
				},
		...
		function(t, e, i) {
			...
			function r(t) {
				if ((t._delayRender && t._delayRender.$cancelTimeout(), t.$gantt)) {
					...
					t[n] && (e.detachEvent(t[n]), (t[n] = null)),
						i.$attachedResourceViewHandler &&
							(i.detachEvent(i.$attachedResourceViewHandler),
				...
				return {
					...
					_linkToTaskStore: function() {
						if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
							...
							var i = this,
								a = n.delay(function() {
									i.$gantt.getState().lightbox
										? a()
										: i.$config.rowStore.refresh();
								}, 300);
							this._delayRender = a;
							...
							i[o] || (i[o] = t.attachEvent('onStoreUpdated', a)),
								...
								e.$attachedResourceViewHandler ||
									(e.$attachedResourceViewHandler = e.attachEvent(
										'onBeforeStoreUpdate',
										function() {
						...
						if (e.$config.fetchTasks) {
							...
							e.silent(function() {
								...
								for (var o in (e.eachItem(function(o) {
									'task' != o.$role
										? t.getTaskBy(i, o.id).forEach(function(i) {
												var a = t.copy(i);
												(a.id = i.id + '_' + o.id),
													(a.$task_id = i.id),
													(a.$resource_id = o.id),
		...
		function(t, e, i) {
			...
			(l.prototype = {
				...
				_validateColumnWidth: function(t, e) {
					...
					if (i && '*' != i) {
						var n = this.$gantt,
							r = 1 * i;
						isNaN(r)
							? n.assert(!1, 'Wrong ' + e + ' value of column ' + t.name)
							: (t[e] = r);
					}
				},
				setSize: function(t, e) {
					...
					for (
						var i, n = this.getGridColumns(), r = 0, a = 0, o = n.length;
						a < o;
						a++
					)
				...
				_bindStore: function() {
					if (this.$config.bind) {
						...
						if (((this.$config.rowStore = t), t && !t._gridCacheAttached)) {
							var e = this;
							t._gridCacheAttached = t.attachEvent(
								'onBeforeFilter',
								function() {
				...
				_unbindStore: function() {
					if (this.$config.bind) {
						...
						t._gridCacheAttached &&
							(t.detachEvent(t._gridCacheAttached),
				...
				scrollTo: function(t, e) {
					if (this.isVisible()) {
						...
						(this.$config.scrollTop = this.$config.scrollTop || 0),
							...
							1 * t == t &&
								((this.$config.scrollLeft = this.$state.scrollLeft = this.$grid.scrollLeft = t),
								(i = !0)),
							1 * e == e &&
								((this.$config.scrollTop = this.$state.scrollTop = this.$grid_data.scrollTop = e),
								(i = !0)),
							i &&
				...
				_getGridWidthLimits: function() {
					for (
						...
						(i += e[r].min_width ? e[r].min_width : t.min_grid_column_width),
							void 0 !== n &&
								(n = e[r].max_width ? n + e[r].max_width : void 0);
					return [i, n];
				},
				_setColumnsWidth: function(t, e) {
					...
					for (o = e + 1; o < n.length; o++) {
						...
						l < 0
							? u.min_width && u.width + d < u.min_width
								? (d = u.min_width - u.width)
								: !u.min_width &&
								  i.min_grid_column_width &&
								  u.width + d < i.min_grid_column_width &&
								  (d = i.min_grid_column_width - u.width)
							: u.max_width &&
							  u.width + d > u.max_width &&
							  (d = u.max_width - u.width),
							(r -= u.width),
							(u.width += d),
							(l -= d);
					}
					for (
						...
						for (o = e + 1; o < n.length; o++) {
							var _;
							if (
								((_ = n[o].width + h) == this._getColumnWidth(n[o], i, _) &&
									((l -= h), (n[o].width = _)),
								!l)
							)
								break;
					...
					l &&
						e > -1 &&
						((_ = n[e].width + l) == this._getColumnWidth(n[e], i, _) &&
							(n[e].width = _));
				...
				_calculateGridWidth: function() {
					for (
						...
						window.isNaN(o) && ((o = t.min_grid_column_width || 10), n.push(a)),
							(r[a] = o),
							(i += o);
					}
					...
					if (t.autofit || n.length) {
						...
						if (t.autofit)
							for (a = 0; a < r.length; a++) {
								...
								(r[a] += c),
									(u = this._getColumnWidth(e[a], t, r[a])) != r[a] &&
										((c = u - r[a]), (r[a] = u)),
									(l -= c);
							}
						else if (n.length)
							for (a = 0; a < n.length; a++) {
								...
								var u,
									d = n[a];
								(r[d] += c),
									(u = this._getColumnWidth(e[d], t, r[d])) != r[d] &&
										((c = u - r[d]), (r[d] = u)),
									(l -= c);
							}
				...
				_renderGridHeader: function() {
					...
					e.rtl && (r = r.reverse());
					for (
						var a = [], o = 0, s = i.labels, l = e.scale_height - 1, c = 0;
						c < r.length;
						c++
					) {
						var u = c == r.length - 1,
						...
						var _ =
							...
							g = [
								...
								'gantt_grid_head_' + d.name,
								u ? 'gantt_last_cell' : '',
								n.grid_header_class(d.name, d)
							].join(' '),
							p = 'width:' + (h - (u ? 1 : 0)) + 'px;',
						...
						var m =
							...
							p +
							"' " +
							t._waiAria.gridScaleCellAttrString(d, v) +
							" data-column-id='" +
							d.name +
							"' column_id='" +
							d.name +
				...
				var r = [],
					a = {
						attach: function(t, i, n, a) {
							r.push({ element: t, event: i, callback: n, capture: a }),
								e(t, i, n, a);
						},
				...
				return {
					...
					getClosestWorkTimeArguments: function(e) {
						...
						return n instanceof o
							...
							: ((i = r.isDate(n)
									? new o(n)
									: new o(n.date, n.dir, n.unit, n.task, null, n.calendar)),
							  n.id && (i.task = n),
							  (i.dir = n.dir || 'any'),
			...
			function a(t) {
				...
				(o.start_date && o.end_date) ||
					(((o = (function(t) {
						...
						o.end_date) ||
						(o = { start_date: new Date(), end_date: new Date() }),
			...
			(o.prototype = r.mixin(
				{
					...
					getChildren: function(t) {
						return r.defined(this._branches[t])
							? this._branches[t]
							: n.$create();
					},
					isChildOf: function(t, e) {
					...
					_add_branch: function(t, e, i) {
						...
						for (
							var a = this.getChildren(r), o = !1, s = 0, l = a.length;
							s < l;
							s++
						)
							if (a[s] == t.id) {
					...
					for (var e = null, i = [], n = 0, r = t.length; n < r; n++)
						(e = t[n]),
							...
							this.callEvent('onItemLoading', [e]) &&
								(this.pull.hasOwnProperty(e.id) || this.fullOrder.push(e.id),
								i.push(e),
								(this.pull[e.id] = e));
					return i;
				},
		...
		function(t, e) {
			t.exports = function(t) {
				function e(e, a) {
					if (!t._isAllowedUnscheduledTask(e)) {
						...
						u == s.types.milestone && s.link_line_width > 1 && (d += 1),
							u == s.types.milestone &&
								((o.left -= Math.round(c / 2)), (o.width = c));
						var h = document.createElement('div'),
							f = Math.round(o.width);
						a.$config.item_attribute &&
							h.setAttribute(a.$config.item_attribute, e.id),
							s.show_progress &&
								u != s.types.milestone &&
								(function(e, i, n, r, a) {
									...
									(l = Math.min(n, l)),
										e.progressColor &&
											((s.style.backgroundColor = e.progressColor),
											(s.style.opacity = 1)),
										(s.style.width = l + 'px'),
										(s.className = 'gantt_task_progress'),
										(s.innerHTML = a.progress_text(
											e.start_date,
											e.end_date,
											e
										)),
						...
						var g = (function(e, i, n, r) {
							...
							if (
								(t.getTaskType(l.type) == a.types.milestone
									? o.push('gantt_milestone')
									: t.getTaskType(l.type) == a.types.project &&
									  o.push('gantt_project'),
								...
								t.isSplitTask(l) &&
									...
									o.push('gantt_split_parent'),
								a.select_task &&
									t.isSelectedTask(n) &&
									o.push('gantt_selected'),
								n == s.drag_id &&
									(o.push('gantt_drag_' + s.drag_mode),
								...
								a.highlight_critical_path &&
									t.isCriticalTask &&
									t.isCriticalTask(l) &&
									o.push('gantt_critical_task'),
								s.link_landing_area &&
									s.link_target_id &&
									s.link_source_id &&
									s.link_target_id != s.link_source_id)
							) {
				...
				function i(t, e, i) {
					...
					var r = document.createElement('div');
					return (
						(r.className = 'gantt_side_content ' + i), (r.innerHTML = n), r
					);
				}
				function n(e, i) {
					var n = (function(e) {
			...
			t.exports = function(t) {
				...
				return {
					...
					adjustSize: function(t, e, i, n) {
						...
						for (
							var r = n - i + 1, a = this.getSum(e, i, n), o = i;
							o <= n;
							o++
						) {
					...
					getSubScales: function(t) {
						var e = this._isLegacyMode(t),
							n = t || i.config();
						return (e ? n.subscales || [] : n.scales.slice(1)).map(
							function(t) {
					...
					prepareConfigs: function(t, e, i, n, r, a, o) {
						for (
							var s = this.splitSize(n, t.length),
								l = i,
								c = [],
								u = t.length - 1;
							u >= 0;
					...
					limitVisibleRange: function(t) {
						...
						if (
							(+l > +t.max_date &&
								...
								((a =
									t.width[o] -
									Math.floor(t.width[o] * ((l - t.max_date) / (l - s)))),
								(r += t.width[o] - a),
								(t.width[o] = a)),
							r)
						) {
							for (
								var c = this.getSum(t.width), u = 0, d = 0;
								d < t.width.length;
								d++
							) {
		...
		function(t, e, i) {
			...
			function c(t, e) {
				for (var i, n, r, a = 0, o = t.length - 1; a <= o; )
					if (((n = +t[(i = Math.floor((a + o) / 2))]), (r = +t[i - 1]), n < e))
						a = i + 1;
					else {
						if (!(n > e)) {
							for (; +t[i] == +t[i + 1]; ) i++;
			...
			(l.prototype = {
				...
				setSize: function(t, e) {
					...
					for (
						...
						var c = o[s];
						c.hasAttribute('data-layer') &&
							c.style &&
							(c.style.width = a.full_width + 'px');
					}
				},
				isVisible: function() {
					return this.$parent && this.$parent.$config
				...
				_attachLayers: function(t) {
					...
					if (this.$config.bind) {
						...
						for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
							'string' == typeof (c = r[a]) &&
								(c = this.$gantt.$ui.layers[c]()),
								('function' == typeof c || (c && c.render && c.update)) &&
									(c = { renderer: c }),
								(c.view = this);
							var o = n.addLayer(c);
								...
								if (a.static_background) {
									...
									s ||
										...
										t.$task_bg.nextSibling
											? t.$task_data.insertBefore(s, t.$task_bg.nextSibling)
											: t.$task_data.appendChild(s)),
										o &&
											e.render(
												s,
												a,
												t.getScale(),
												a.row_height * o.countVisible()
											);
								} else
									a.static_background &&
										t.$task_bg_static &&
				...
				_render_tasks_scales: function() {
					...
					if (this.isVisible()) {
						...
						('x' != t.autosize && 'xy' != t.autosize) ||
							(s = Math.max(t.autosize_min_width, 0));
					...
					for (var h = u; h < d && t.trace_x[h]; h++) {
						...
						if (_) {
							(v =
								...
								(y =
									'gantt_scale_cell' +
									(h == t.count - 1 ? ' gantt_last_cell' : '')),
								(m = s.call(this, o)) && (y += ' ' + m);
							var b =
								"<div class='" +
								y +
								"'" +
								this.$gantt._waiAria.getTimelineCellAttr(f) +
								" style='" +
								v +
								"'>" +
								f +
				...
				dateFromPos: function(t) {
					...
					var o = 0;
					return (
						a && (o = this._getColumnDuration(e, e.trace_x[i])),
				...
				posFromDate: function(t) {
					...
					n == this._tasks.width.length &&
						(a += this._tasks.width[this._tasks.width.length - 1]),
						r &&
							(n < this._tasks.width.length
								? (a += this._tasks.width[n] * (r % 1))
								: (a += 1));
					var o = Math.round(a);
				...
				a = (function(t) {
					...
					return (
							...
							if (t.length)
								for (
									...
									'resizer' == o.$name &&
										(o =
											n > 0
												? o.$parent.getNextSibling(o.$id)
												: o.$parent.getPrevSibling(o.$id));
									var s = o.getSize();
									if (o[i]) {
							...
							if (
								...
								if (
									(this.$config.autosize &&
										(this.autosize(this.$config.autosize), (s = !0)),
									s)
								) {
									this.resize();
									for (a = 0; a < n.length; a++)
						...
						(e.prototype.$fill = function(t, e) {
							...
							for (
								var i = r.getChildNodes(t, 'gantt_layout_cell'),
									n = i.length - 1;
								n >= 0;
								n--
							) {
						...
						(e.prototype.getContentSize = function(t) {
							for (
								var e, i, n, r = 0, a = 0, o = 0;
								o < this.$cells.length;
								o++
							)
								(i = this.$cells[o]).$config.hidden ||
						...
						(e.prototype.getSize = function() {
							this._sizes = [];
							for (
								var e = 0, i = 0, n = 1e5, r = 0, a = 1e5, o = 0, s = 0;
								s < this.$cells.length;
								s++
							) {
								var l = (this._sizes[s] = this.$cells[s].getSize());
								this.$cells[s].$config.hidden ||
									(this._xLayout
										? (!l.width && l.minWidth
												? (e += l.minWidth)
												: (e += l.width),
							...
							for (o = 0; o < this.$cells.length; o++)
								if (!(n = this.$cells[o]).$config.hidden) {
									...
									var h = void 0,
										f = void 0;
									this._xLayout
										? ((h = this._calcSize(r.width, r, !0)), (f = i - 2 * a))
										: ((h = e - 2 * a), (f = this._calcSize(r.height, r, !1))),
										n.setSize(h, f);
								}
						}),
						e
				...
				(t.assert = i(46)(t)),
						...
						this.callEvent('onBeforeGanttReady', []),
							...
							(function(t) {
								...
								(e.className = 'gantt_container_resize_watcher'),
									...
									e.contentWindow
										? a(t, e.contentWindow)
										: (t.$root.removeChild(e), a(t, window));
							})(t),
					...
					(t._is_icon_open_click = function(t) {
						...
						return (
							...
							(-1 !== i.indexOf('gantt_close') ||
								-1 !== i.indexOf('gantt_open'))
						);
					});
			};
		},
		...
		function(t, e) {
			t.exports = function(t) {
				...
				t._touch_events = function(n, r, a) {
					for (
						var o, s = 0, l = !1, c = !1, u = null, d = null, h = null, f = 0;
						f < i.length;
						f++
					)
							...
							function(i) {
								if (!a(i)) {
									...
									if (
										(o && o.on_mouse_up(n),
										h &&
											(t.refreshTask(t.locate(h)),
											h.parentNode &&
												(h.parentNode.removeChild(h), t._touch_feedback())),
		...
		function(t, e) {
			function i(t, e) {
				...
				s[1] && !e.defined(s[1].width) && (s[1].width = o._second_column_width),
					s[2] &&
						!e.defined(s[2].width) &&
						(s[2].width = o._third_column_width);
				...
				o.config.task_height &&
					...
					o._redefine_lightbox_buttons &&
						...
						(e.config.buttons_left =
							o._redefine_lightbox_buttons.buttons_left)),
					e.resetLightbox();
			}
			t.exports = function(t) {
				t.resetSkin ||
			...
			t.exports = function(t) {
				...
				return (
					...
					(r.prototype.render = function(i) {
						...
						for (var s in n)
							!1 == !o(s, n[s]) && a.push({ key: n[s], label: r['type_' + s] });
						i.options = a;
						var l = i.onchange;
						return (
							(i.onchange = function() {
					...
					var i = e,
						n = {
							...
							button_click: function(e, i, r, a) {
								if (
									!1 !== t.callEvent('onSectionButton', [t._lightbox_id, r])
								) {
				...
				return (
					...
					(a.prototype.get_value = function(e, i, n) {
						var r = e.querySelector('[data-constraint-type-select] select'),
							...
							l = null;
						return (
							o(s) || (l = t.form_blocks.getTimePickerValue(a, n)),
							{ constraint_type: s, constraint_date: l }
						);
					}),
					(a.prototype.focus = function(e) {
				...
				return (
					...
					(l.prototype.set_value = function(e, i, o, l) {
						var h,
							f = (function(t, e) {
								s.resources[e.id] ||
									(s.resources[e.id] = t.querySelector('.gantt_resources'));
						...
						!(function(t, e) {
							...
							(function(e, i, a, o) {
											...
											if (a) {
												...
												o = function(t) {
													if (
														h[String(t.key)] &&
														('' === r ||
															t.label.toLowerCase().indexOf(r.toLowerCase()) >=
																0)
													)
														return t;
												};
												...
												o = function(t) {
													if (
														t.label.toLowerCase().indexOf(r.toLowerCase()) >= 0
													)
														return t;
												};
											}
											return (
												((l = t.copy(e)).options = n.arrayFilter(l.options, o)),
												l
											);
										})(a, i, c, u)),
										(g.filterApplied = !0),
								...
								function h(e) {
									...
									if ('checkbox' === e.target.type) {
										...
										if (
											(u.setAttribute('data-checked', o.checked), o.checked)
										) {
											'select' === n.nodeName.toLowerCase() &&
												t.callEvent('onResourcesSelectActivated', [
													{ target: n }
												]);
											var h = l,
												_ = a.default_value;
											...
											s.resourcesValues[a.id] &&
												delete s.resourcesValues[a.id][l];
									} else
										('text' !== e.target.type &&
								...
								function f(t, e) {
									...
									for (var r = 0; r < n.length; r++) {
										...
										n[r].disabled
											? delete s.resourcesValues[t.id][a]
											: (s.resourcesValues[t.id][a] = n[r].value);
									}
								}
								(l = n.throttle(l, 100)),
							...
							n.forEach(l.options, function(t, e) {
								l.unassigned_value != t.key &&
									((h = (function(t, e, i) {
										var r = {};
										if (e) {
											var a;
											n.isArray(e)
												? (a = n.arrayFind(e, function(t) {
														return t.resource_id == i.key;
												  }))
												: e.resource_id == i.key && (a = e),
												a && (r.value = a.value);
										}
										s.resourcesValues[t.id] &&
											s.resourcesValues[t.id][i.key] &&
											(r.value = s.resourcesValues[t.id][i.key]);
										return r;
									})(l, i, t)),
									(_ += [
										...
										(function(t, e, i) {
											...
											if (!t) return;
											(n = [
												{ key: 'data-item-id', value: t.key },
												{ key: 'class', value: 'gantt_resource_amount_input' }
											]),
												i && n.push({ key: 'disabled', value: 'disabled' });
											t.options
												? (r += a.getHtmlSelect(t.options, n, e))
												: ((n[n.length] = { key: 'value', value: e || '' }),
												  (r += a.getHtmlInput(n)));
											return r;
										})(t, h.value, !h.value),
										'</div>',
					...
					(l.prototype.get_value = function(t, e, i) {
						...
						h.filterApplied &&
							f &&
							f.length > 0 &&
							n.forEach(f, function(t) {
								_[String(t.resource_id)] = t;
							});
						for (
							var g = r.querySelectorAll(o), p = r.querySelectorAll(l), v = 0;
							v < p.length;
							v++
						)
						...
						for (v = 0; v < g.length; v++) {
							...
							'' !== y &&
								'0' !== y &&
								(delete _[m], (a[a.length] = { resource_id: m, value: y }));
						}
						for (var b in _)
							s.resourcesValues[i.id]
								? (a[a.length] = s.resourcesValues[i.id][b] || _[b])
								: (a[a.length] = _[b]);
						return a;
					}),
		...
		function(t, e, i) {
			...
			t.exports = function(t) {
				...
				function a(e, i) {
					...
					i &&
						...
						(n = (function(e, i, n) {
							...
							for (var a = 0; a < e.length; a++) {
								var o = e[a];
								(o.id == n || t.isChildOf(o.id, n) || !1 === r(o.id, o)) &&
									(e.splice(a, 1), a--);
							}
							return e;
						})(n, e, i)),
					...
					for (
						var a = e.template || t.templates.task_text, o = 0;
						o < n.length;
						o++
					) {
			...
			t.exports = function(t) {
				...
				function a(e, i) {
					...
					if (t.defined(r[3])) {
						...
						isNaN(l) &&
							s.hasAttribute('data-value') &&
							(l = parseInt(s.getAttribute('data-value'), 10)),
							(a = Math.floor(l / 60)),
							(o = l % 60);
					}
				...
				return (
					...
					(r.prototype.set_value = function(e, i, n, r) {
						...
						(g[0].onclick = t.bind(function() {
							...
							'string' == typeof (s = t._resolve_default_mapping(r)) &&
								(s = { start_date: s }),
							(l = n[s.start_date] || new Date()),
							(c =
								n[s.end_date] ||
								t.calculateEndDate({ start_date: l, duration: 1, task: n })),
							(u =
								Math.round(n[s.duration]) ||
								t.calculateDuration({ start_date: l, end_date: c, task: n })),
					...
					(r.prototype.get_value = function(e, i, n) {
						var r = a(e, n),
							s = o(e),
							l = t.calculateEndDate({ start_date: r, duration: s, task: i });
						return 'string' == typeof t._resolve_default_mapping(n)
							? r
							: { start_date: r, end_date: l, duration: s };
					}),
				...
				return (
					...
					(r.prototype.set_value = function(e, i, n, r) {
						...
						var d = n[u.start_date] || new Date(),
							h =
								n[u.end_date] ||
								t.calculateEndDate({ start_date: d, duration: 1, task: n });
					...
					(r.prototype.get_value = function(e, i, n) {
						...
						return (
							(r = t.form_blocks.getTimePickerValue(a, n)),
							...
							for (
								e._time_format_order[2] = i,
									...
									e.year_range &&
										(isNaN(e.year_range)
											? e.year_range.push &&
											  ((o = e.year_range[0]), (s = e.year_range[1]))
											: (r = e.year_range)),
									r = r || 10,
									a = a || Math.floor(r / 2),
				...
				(t._lightbox_methods = {}),
					...
					(t.getLightbox = function(e) {
						...
						return (
							...
							(this._lightbox &&
								...
								n &&
									((t.config.wide_form = !0), (o += ' gantt_cal_light_full')),
								(i.className = o),
						...
						(t.lightbox_events = {}),
							...
							(t.lightbox_events.default = function(i, n) {
								if (n.getAttribute('data-dhx-button'))
									...
									r &&
										((r *= 1),
										t.form_blocks[s[1 * r].type].button_click(
											r,
											n,
											a,
											a.nextSibling
					...
					(t._resolve_default_mapping = function(t) {
						...
						return (
							!{
								...
								: 'string' == typeof t.map_to && (e = { start_date: t.map_to }),
							e
						);
					}),
					...
					(t._set_lightbox_values = function(e, i) {
						...
						t.templates.lightbox_header
							? (a.push(''),
							  a.push(
									t.templates.lightbox_header(n.start_date, n.end_date, n)
							  ),
							  (r[1].innerHTML = ''),
						...
						for (
							var o = this._get_typed_lightbox_config(this.getLightboxType()),
								s = 0;
							s < o.length;
							s++
						) {
					...
					(t.form_blocks = {
						getTimePicker: function(e, i) {
							...
							for (
								...
								r > 0 && (s += ' '),
									(a = g(e, r, c)) &&
										((o = t._waiAria.lightboxSelectAttrString(c.timeFormat[r])),
										(s +=
											'<select ' +
			...
			t.exports = function(t) {
				(t.isUnscheduledTask = function(e) {
					...
					(t.createTask = function(e, i, n) {
						...
						this.isTaskExists(i)) &&
							(this.setParent(e, i, !0), (this.getTask(i).$open = !0));
						...
						if (
							...
							for (
								o = Math.floor(t.columnIndexByDate(s)),
									...
									i.trace_x[o] && (r = t.date[c + '_start'](i.trace_x[o]));
								+r < +s;

							) {
								var u = (r = t.date[c + '_start'](
									t.date.add(r, l, c)
								)).getTimezoneOffset();
				...
				return (
					...
					(t.prototype.setItem = function(t, e, i) {
						if (t && e) {
							var n,
								r = this._cache;
							r.has(t) ? (n = r.get(t)) : ((n = new Map()), r.set(t, n)),
								n.set(e, i);
						}
					}),
					(t.prototype.clear = function() {
			...
			(a.prototype = {
				...
				_getWorkUnitsBetweenGeneric: function(t, e, i, n) {
					...
					var s,
						...
						u = null,
						d = !1;
					(s = r[i + '_start'](new Date(a))).valueOf() != a.valueOf() &&
						(d = !0);
					var h = !1;
					(l = r[i + '_start'](new Date(e))).valueOf() != e.valueOf() &&
						(h = !0);
					for (var f = !1; a.valueOf() < o.valueOf(); )
						(f = (u = this._nextDate(a, i, n)).valueOf() > o.valueOf()),
							this._isWorkTime(a, i) &&
								((d || (h && f)) &&
									((s = r[i + '_start'](new Date(a))), (l = r.add(s, n, i))),
								d
									? ((d = !1),
				...
				_getHoursPerDay: function(t) {
					for (
						var e = this._getWorkHours(t), i = 0, n = 0;
						n < e.length;
						n += 2
					)
						i += e[n + 1] - e[n] || 0;
				...
				_getWorkUnitsForRange: function(t, e, i, n) {
					...
					for (
						a =
							'minute' == i
								? r.bind(this._getMinutesPerDay, this)
								: r.bind(this._getHoursPerDay, this);
						s.valueOf() < l.valueOf();
				...
				_isWorkTime: function(t, e, i) {
					...
					return (
						-1 == r &&
							((r = this._checkIfWorkingUnit(t, e, i)),
				...
				calculateDuration: function() {
					...
					return (
						!!t.unit &&
						this._calculateDuration(t.start_date, t.end_date, t.unit, t.step)
					);
				},
				_calculateDuration: function(t, e, i, n) {
					var r = 0;
					return (
						(r =
							'hour' == i || 'minute' == i
								? this._getWorkUnitsBetweenQuick(t, e, i, n)
								: this._getWorkUnitsBetweenGeneric(t, e, i, n)),
						Math.round(r)
					);
				},
				hasDuration: function() {
				...
				_calculateEndDate: function(t, e, i, n) {
					return (
						!!i &&
						(1 == n && 'minute' == i
							? this._calculateMinuteEndDate(t, e, n)
							: 1 == n && 'hour' == i
							? this._calculateHourEndDate(t, e, n)
							: this._addInterval(t, e, i, n, null).end)
					);
				},
					...
					if (((r = a.added), (n = a.end), (c = e - r) && c > 24)) {
						for (var o = n; r < e; ) {
							...
							if (
								...
								s.setSeconds(0),
								this._isWorkTime(
									i > 0 ? new Date(s.valueOf() - 1) : new Date(s.valueOf() + 1),
									'day'
								))
							) {
				...
				_calculateMinuteEndDate: function(t, e, i) {
					...
					if (((r = a.added), (n = a.end), r < e)) {
						var o = e - r,
							s = Math.floor(o / 60);
						s &&
							((n = this._calculateEndDate(n, s, 'hour', i > 0 ? 1 : -1)),
							(r += 60 * s));
					}
					if (r < e) {
						var l = e - r;
				...
				_getClosestWorkTime: function(t, e, i) {
					...
					if (((n = this.$gantt.date[e + '_start'](n)), 'any' != i && i))
						n =
							'past' == i
								? this._getClosestWorkTimePast(n, e)
								: this._getClosestWorkTimeFuture(n, e);
					else {
				...
				_getClosestWorkTimeGeneric: function(t, e, i) {
					for (
						var n = this._getUnitOrder(e), r = this.units[n - 1], a = t, o = 0;
						!this._isWorkTime(a, e) &&
						(!r ||
							this._isWorkTime(a, r) ||
							((a =
								i > 0
									? this._getClosestWorkTimeFuture(a, r)
									: this._getClosestWorkTimePast(a, r)),
							!this._isWorkTime(a, e)));
				...
				mergeCalendars: function() {
					...
					for (var a = 0; a < n.length; a++)
						for (var o in n[a].worktime.dates)
							+o > 1e4 &&
								((i = this._getDayHoursForMultiple(n, new Date(+o))),
						...
						_copyObject: function(e) {
							...
							for (var r in e)
								'$' != r.charAt(0) &&
									...
									n.isDate(i[r]) &&
										(i[r] =
											t.templates.xml_format !== t.templates.formate_date
												? t.templates.xml_format(i[r])
												: t.templates.formate_date(i[r])));
							return i;
						},
						serialize: function() {
							var e = [],
					...
					(t.oldxml = {
						parse: function(e, i) {
							...
							for (
								...
								'project' == s.tagName
									? (r[o].parent = 'project-' + s.getAttribute('id'))
									: (r[o].parent = s.parentNode.getAttribute('id'));
							}
				...
				for (var o in ((t._waiAria = {
					...
					_taskCommonAttr: function(e, i) {
						e.start_date &&
							...
							i.setAttribute(
								'aria-selected',
								t.isSelectedTask(e.id) ? 'true' : 'false'
							));
					},
					...
					linkAttr: function(e, i) {
						var r = t.config.links,
							...
							s =
								...
								' ' +
								t.templates.drag_link(e.source, o, e.target, a);
						...
						(this.zoomIn = function() {
							...
							(this._setLevel = function(t, i) {
								...
								if ((delete a.name, n.mixin(n.config, a, !0), !!n.$root)) {
									if (i) {
										var o = e.$gantt.dateFromPos(
											i + e.$gantt.getScrollState().x
										);
										e.$gantt.render();
							...
							(this._defaultHandler = function(t) {
								var i = e.$gantt.$task.getBoundingClientRect().x,
									n = t.clientX - i,
									r = !1;
								(e.$gantt.env.isFF ? -40 * t.deltaY : t.wheelDelta) > 0 &&
									(r = !0),
									t.preventDefault(),
									t.stopPropagation(),
							...
							(this._setScaleDates = function() {
								e._initialStartDate &&
									e._initialEndDate &&
									((e.$gantt.config.start_date = e._initialStartDate),
					...
					return (
						(t.prototype.init = function(t) {
							...
							(this._initialStartDate = t.startDate),
								...
								(this._activeLevelIndex = t.activeLevelIndex
									? t.activeLevelIndex
									: 0),
				...
				t.attachEvent('onGanttReady', function() {
					r ||
						...
						t.attachEvent(
							'onAfterTaskAdd',
							e(function(e, n) {
								n.type != t.config.types.placeholder &&
									(t
					...
					t.attachEvent('onBeforeUndoStack', function(e) {
						for (var i = 0; i < e.commands.length; i++) {
							var n = e.commands[i];
							'task' === n.entity &&
								n.value.type === t.config.types.placeholder &&
								(e.commands.splice(i, 1), i--);
						}
						return !0;
					});
			};
		...
		function(t, e, i) {
			...
			function a(t) {
				...
				function l(n, r, a, o) {
					...
					return e[s]
						? e[s]
						: (e[s] = (function(e, n, r, a) {
								p = 'task' == e.$role ? [] : i(n, e.id);
								for (
									var o = r.unit, s = r.step, l = {}, c = 0;
									c < p.length;
									c++
								)
									for (
										var u = p[c],
											d = t.date[o + '_start'](new Date(u.start_date));
										d < u.end_date;
										...
										if (
											((d = t.date.add(d, s, o)),
											t.isWorkTime({ date: h, task: u, unit: o }))
										) {
											var f = h.valueOf();
											l[f] || (l[f] = []), l[f].push(u);
										}
								...
								for (
									var _, g, p, v = [], m = a.$getConfig(), c = 0;
									c < r.trace_x.length;
									c++
								)
									(_ = new Date(r.trace_x[c])),
										(g = t.date.add(_, s, o)),
										((p = l[_.valueOf()] || []).length ||
											m.resource_render_empty_cells) &&
											v.push({ start_date: _, end_date: g, tasks: p });
								return v;
						  })(n, r, a, o));
				}
				function c(t, e, i, n) {
					...
					return (
						(s.className = 'gantt_histogram_hor_bar'),
						(s.style.top = r + '%'),
						(s.style.left = a + 'px'),
				...
				function u(t, e, i) {
					...
					return (
						(a.className = 'gantt_histogram_vert_bar'),
						(a.style.top = 100 * n + '%'),
				...
				return {
					renderLine: function() {
						...
						function e(t, e, i, n, r) {
							...
							if (a || o) {
								...
								return (
									(l.className = ['gantt_resource_marker', a].join(' ')),
									(l.style.cssText = [
										'left:' + s.left + 'px',
										'width:' + s.width + 'px',
										'height:' + (n.row_height - 1) + 'px',
										'line-height:' + (n.row_height - 1) + 'px',
										'top:' + s.top + 'px'
									].join(';')),
									o && (l.innerHTML = o),
									l
						...
						function i(e, i) {
							t[e] &&
								t[e][i] &&
								t[e][i].parentNode &&
								t[e][i].parentNode.removeChild(t[e][i]);
						}
						return {
							render: function(i, n, r) {
								...
								if (u.length)
									for (
										p = document.createElement('div'), h = 0;
										h < u.length;
										h++
									)
										p.appendChild(u[h]);
							...
							update: function(n, r, a, o) {
								for (
									var s = a.$getConfig(),
										c = a.$getTemplates(),
										u = a.getScale(),
										h = l(n, s.resource_property, a.getScale(), a),
										f = 0;
									f < h.length;
									f++
								) {
					...
					renderHistogram: function() {
						...
						function o(e, i, r, a, o, s, l) {
							...
							return (
								f &&
									(f.setAttribute('data-resource-id', e.id),
						...
						function s(t, e, i, n, r, a) {
							var o = r.histogram_cell_class(
									a.start_date,
									a.end_date,
									t,
									a.tasks
								),
								s = r.histogram_cell_label(
									a.start_date,
									a.end_date,
									t,
									a.tasks
								),
								l = r.histogram_cell_allocated(
									a.start_date,
									a.end_date,
									t,
									a.tasks
							...
							if (o || s) {
								var c = document.createElement('div');
								return (
									(c.className = ['gantt_histogram_cell', o].join(' ')),
									(c.style.cssText = [
										'left:' + e.left + 'px',
										'width:' + e.width + 'px',
										'height:' + (n.row_height - 1) + 'px',
									...
									s &&
										(s = "<div class='gantt_histogram_label'>" + s + '</div>'),
									l &&
										(s =
											"<div class='gantt_histogram_fill' style='height:" +
											100 * Math.min(l / i || 0, 1) +
											"%;'></div>" +
											s),
									s && (c.innerHTML = s),
									c
						...
						return {
							render: function(t, r, a) {
								...
								for (var v = 0; v < f.length; v++) {
									...
									if (d(y, h, a)) {
										var b = u.histogram_cell_capacity(
											m.start_date,
											m.end_date,
											t,
											m.tasks
								...
								if (_.length) {
									for (
										x = document.createElement('div'), v = 0;
										v < _.length;
										v++
									)
										x.appendChild(_[v]);
							...
							update: function(t, i, r, c) {
								for (
									var u = r.$getConfig(),
										h = r.$getTemplates(),
										f = r.getScale(),
										_ = l(t, u.resource_property, f, r),
										g = t.capacity || r.$config.capacity || 24,
										p = {},
										v = 0;
									v < _.length;
									v++
		...
		function(t, e) {
			window.dhtmlx &&
				...
				void 0 !== window.dhtmlXCellObject &&
					(window.dhtmlXCellObject.prototype.attachGantt = function(t, e, i) {
						i = i || window.gantt;
						var n = document.createElement('DIV');
						return (
							(n.id = 'gantt_' + i.uid()),
		...
		function(t, e, i) {
			...
			t.exports = function(t) {
				...
				function _(t) {
					t
						? (f(!0), c.started || ((c.x = u.x), (c.y = u.y), (c.started = !0)))
						: (o && (clearInterval(o), (o = null)), f(!1), (c.started = !1));
				}
				function g(e) {
					var i = h();
				...
				function p() {
					if (!h()) return _(!1), !1;
					var e = n.getNodePosition(
							d(t.$task) ? t.$task : d(t.$grid) ? t.$grid : t.$root
						),
						r = u.x - e.x,
						a = u.y - e.y,
		...
		function(t, e, i) {
			t.exports = function(t) {
				t.ext || (t.ext = {});
				for (
					var e = [i(97), i(96), i(95), i(94), i(93), i(92), i(91), i(90)],
						n = 0;
					n < e.length;
					n++
				)
				...
				(e.default = function(t, e) {
					(t.getUserData = function(t, e) {
						...
						(t._row_style = function(e, i) {
							'task' === this._dp._ganttMode &&
								t.isTaskExists(e) &&
								((t.getTask(e).$dataprocessor_class = i), t.refreshTask(e));
						}),
				...
				r = (function() {
					...
					return (
						(t.prototype.attach = function() {
							...
							function a(i) {
								for (
									var n = t.updatedRows.slice(), r = !1, a = 0;
									a < n.length && !t._in_progress[i];
									a++
								)
									n[a] === i &&
										('inserted' === e.getUserData(i, '!nativeeditor_status') &&
											(r = !0),
										t.setUpdated(i, !1));
								return r;
							}
							this._dataProcessorHandlers.push(
								e.attachEvent('onAfterTaskAdd', function(i, n) {
									e.isTaskExists(i) &&
										(t.setGanttMode('tasks'), t.setUpdated(i, !0, 'inserted'));
								})
							),
								this._dataProcessorHandlers.push(
									e.attachEvent('onAfterTaskUpdate', function(i, n) {
										e.isTaskExists(i) &&
								...
								this._dataProcessorHandlers.push(
									e.attachEvent('onBeforeTaskDelete', function(t, i) {
										return (
								...
								this._dataProcessorHandlers.push(
									e.attachEvent('onAfterTaskDelete', function(i, n) {
										if ((t.setGanttMode('tasks'), !a(i))) {
											if (e.config.cascade_delete && r[i]) {
												...
												for (var l in (t.setGanttMode('links'), s.links))
													a(l) || t.setUpdated(l, !0, 'deleted');
												(r[i] = null),
													'off' !== o && t.sendAllData(),
													t.setGanttMode('tasks'),
								...
								this._dataProcessorHandlers.push(
									e.attachEvent('onAfterLinkUpdate', function(i, n) {
										e.isLinkExists(i) &&
											(t.setGanttMode('links'), t.setUpdated(i, !0));
									})
								),
								this._dataProcessorHandlers.push(
									e.attachEvent('onAfterLinkAdd', function(i, n) {
										e.isLinkExists(i) &&
								...
								this._dataProcessorHandlers.push(
									e.attachEvent('onAfterLinkDelete', function(e, i) {
										t.setGanttMode('links'),
											!a(e) && t.setUpdated(e, !0, 'deleted');
									})
								),
								this._dataProcessorHandlers.push(
									e.attachEvent('onRowDragEnd', function(t, i) {
							...
							var o = null,
								s = null;
							this._dataProcessorHandlers.push(
								e.attachEvent('onTaskIdChange', function(i, n) {
									if (t._waitMode) {
								...
								t.attachEvent('onAfterUpdateFinish', function() {
									(o || s) &&
										...
										o
											? e._dp.setGanttMode('tasks')
											: e._dp.setGanttMode('links'));
								}),
								t.attachEvent('onBeforeDataSending', function() {
									...
									if ('REST-JSON' === this._tMode || 'REST' === this._tMode) {
										...
										this.serverProcessor =
											t + e.ajax.urlSeparator(t) + 'gantt_mode=' + n;
									}
									return !0;
								}),
								t.attachEvent('insertCallback', function(t, i, n, r) {
									var a = t.data || e.xml._xmlNodeToJSON(t.firstChild),
										o = { add: e.addTask, isExist: e.isTaskExists };
									'links' === r &&
										((o.add = e.addLink), (o.isExist = e.isLinkExists)),
										o.isExist.call(e, i) || ((a.id = i), o.add.call(e, a));
								}),
									...
									if (e.isTaskExists(i)) {
										...
										for (var a in n) {
											...
											switch (a) {
												...
												case 'end_date':
													o =
														e.templates.xml_date !== e.templates.parse_date
															? e.templates.xml_date(o)
															: e.templates.parse_date(o);
													break;
												case 'duration':
								...
								t.attachEvent('deleteCallback', function(t, i, n, r) {
									...
									'links' === r &&
										((a.delete = e.deleteLink), (a.isExist = e.isLinkExists)),
		...
		function(t, e, i) {
			...
			e.createDataProcessor = function(t) {
				...
				t instanceof Function
					...
					? (e = t.router)
					: t.hasOwnProperty('link') && t.hasOwnProperty('task') && (e = t),
					(i = e ? 'CUSTOM' : t.mode || 'REST-JSON');
				var n = new l(t.url);
				return (
					n.init(this),
					n.setTransactionMode({ mode: i, router: e }, t.batchUpdate),
					n
				);
			};
			var l = (function() {
				...
				return (
					...
					(t.prototype.sendData = function(t) {
						if (
							!this._waitMode ||
							('tree' !== this.$gantt.mytype && !this.$gantt._h2)
						) {
							if (
					...
					(t.prototype.serialize = function(t, e) {
						...
						for (var r in t)
							t.hasOwnProperty(r) &&
								(i.push(this.serialize_one(t[r], r + this._postDelim)),
								n.push(r));
						return (
					...
					(t.prototype._serializeAsJSON = function(t) {
						...
						return (
							'REST-JSON' === this._tMode &&
								(delete e.id, delete e[this.action_param]),
							JSON.stringify(e)
						);
					}),
									...
									o =
										...
										(this._user
											? n.urlSeparator(this.serverProcessor) +
											  [
													'dhx_user=' + this._user,
													'dhx_version=' + this.$gantt.getUserData(0, 'version')
											  ].join('&')
											: ''),
					...
					(t.prototype._getAllData = function() {
						var t = {},
							e = !1;
						return (
							this._forEachUpdatedRow(function(i) {
								if (!this._in_progress[i] && !this.is_invalid(i)) {
									var n = this._getRowData(i);
									this.callEvent('onBeforeUpdate', [i, this.getState(i), n]) &&
										((t[i] = n),
										(e = !0),
					...
					(t.prototype.afterUpdateCallback = function(t, e, i, n) {
						if (this.$gantt) {
							...
							'wait' !== this._in_progress[r]
								? (a && this.$gantt.setUserData(t, this.action_param, ''),
								  delete this._in_progress[r])
								: (delete this._in_progress[r],
								  this.setUpdated(
										e,
										!0,
										this.$gantt.getUserData(t, this.action_param)
								  )),
					...
					(t.prototype.afterUpdate = function(t, e, i) {
						...
						var r = this.getGanttMode(),
							a = n.filePath || n.url;
						(r =
							'REST' !== this._tMode && 'REST-JSON' !== this._tMode
								? -1 !== a.indexOf('gantt_mode=links')
									? 'link'
									: 'task'
					...
					(t.prototype.fullSync = function() {
						return (
							this._needUpdate && ((this._needUpdate = !1), this.loadUpdate()),
							!0
						);
					}),
					...
					(t.prototype.setGanttMode = function(t) {
						...
						var n = e[t];
						n ||
							(n = e[t] = { _in_progress: {}, _invalid: {}, updatedRows: [] }),
					...
					(t.prototype._getRowData = function(t) {
						var e;
						(e =
							'task' === this.getGanttMode()
								? this.$gantt.isTaskExists(t)
									? this.$gantt.getTask(t)
									: { id: t }
								: this.$gantt.isLinkExists(t)
								? this.$gantt.getLink(t)
								: { id: t }),
							(e = this.$gantt.copy(e));
						var i = {};
						for (var n in e)
							if ('$' !== n.substr(0, 1)) {
								...
								r.isDate(a)
									? (i[n] =
											this.$gantt.templates.xml_format !==
											this.$gantt.templates.format_date
												? this.$gantt.templates.xml_format(a)
												: this.$gantt.templates.format_date(a))
									: (i[n] = null === a ? '' : a);
							}
						var o = this.$gantt._get_task_timing_mode(e);
						return (
							o.$no_start && ((e.start_date = ''), (e.duration = '')),
							o.$no_end && ((e.end_date = ''), (e.duration = '')),
							(i[this.action_param] = this.$gantt.getUserData(
								t,
								this.action_param
							)),
							i
					...
					i.attachEvent('onStoreUpdated', function(i, n, r) {
						...
						i.attachEvent('onStoreUpdated', function(a, s, l) {
							if (!o(e)) {
								...
								c &&
									(a && 'move' != l && 'delete' != l
										? (i.callEvent('onBeforeRefreshItem', [s.id]),
										  n(s.id, c),
										  i.callEvent('onAfterRefreshItem', [s.id]))
					...
					}),
					{
						select: function(t) {
							if (t) {
								...
								if (
									!this._skip_refresh &&
									!this.callEvent('onBeforeSelect', [t])
								)
									return !1;
								this.unselect(),
									(e = t),
						...
						unselect: function(t) {
							(t = t || e) &&
								((e = null),
								this._skip_refresh || (this.refresh(t), n.call(this, t)));
						}
					}
				);
			};
			...
			t.exports = function() {
				return {
					...
					moveTask: function(t, e, i) {
						return this.$data.tasksStore.move.apply(
							this.$data.tasksStore,
							arguments
						);
					},
			...
			t.exports = function(t) {
				...
				var o = t.createDatastore({
						...
						initItem: n.bind(function(e) {
							this.defined(e.id) || (e.id = this.uid()),
								e.start_date &&
									(e.start_date = t.date.parseDate(e.start_date, 'parse_date')),
								e.end_date &&
									(e.end_date = t.date.parseDate(e.end_date, 'parse_date'));
							var i = null;
							...
							return (
								r && !n.defined(e.open) && (e.$open = r.$open),
				...
				t.attachEvent('onDestroy', function() {
					...
					o.attachEvent('onAfterUpdate', function(e) {
						if ((t._update_parents(e), t.getState('batchUpdate').batch_update))
							return !0;
					...
					s.attachEvent('onBeforeIdChange', function(e, i) {
						u(t.mixin({ id: e }, t.$data.linksStore.getItem(i))),
							...
							t.attachEvent('onAfterTaskDelete', function(e, i) {
								n[e] &&
									t.$data.linksStore.silent(function() {
										for (var i in n[e])
											t.$data.linksStore.removeItem(i), u(n[e][i]);
										n[e] = null;
									});
							});
					})(),
				...
				r = function(t) {
					return {
							...
							this._legacyGridResizerClass(e),
								e.attachEvent('onBeforeResize', function() {
									...
									if (a) {
										...
										if (
											((a.$config.hidden = a.$parent.$config.hidden = !o),
											!a.$config.hidden)
										) {
						...
						_initScrollStateEvents: function(e) {
							...
							i &&
								i.attachEvent('onScroll', function(e, i, n) {
									var r = t.getScrollState();
									t.callEvent('onGanttScroll', [r.x, e, r.x, i]);
								}),
								n &&
									n.attachEvent('onScroll', function(e, i, n) {
										var r = t.getScrollState();
				...
				r = function(t, e) {
					...
					function g(i, n, r, a, o) {
						var s = (function(i, n, r) {
								var a = n(i),
									o = { x: a.left, y: a.top, width: a.width, height: a.height };
								r.rtl
									? ((o.xEnd = o.x), (o.x = o.xEnd + o.width))
									: (o.xEnd = o.x + o.width);
								if (
									((o.yEnd = o.y + o.height),
						...
						var c =
							(function(t) {
								...
								: 0;
						return (
							(r = r || 0), a.rtl && (r *= -1), (l.x += (n ? -1 : 1) * r - c), l
						);
					}
					function p(t, i) {
						var n = _.getPosition(t),
							r = (function(t) {
								var e = 0,
									i = 0;
								return (
									t && ((e = t.offsetWidth || 0), (i = t.offsetHeight || 0)),
									{ width: e, height: i }
								);
							})(i),
							a = (function() {
						...
						return (
							d.bottom > a.bottom && (d.y = a.bottom - r.height - s),
						...
						_.attachEvent(
							...
							e.bind(function(o, s) {
								...
								var u = !!n.locateClassName(s, 'gantt_link_control'),
									...
									b = !0;
								if (
									(n.isChildOf(s.target || s.srcElement, e.$root) ||
										((u = !1), (m = null)),
									u &&
										((b = !n.locateClassName(s, 'task_end_date')), (u = !!m)),
									(r = m),
									(i = u),
									(a = b),
									u)
								...
								var S = !(h == u && d == m && f == b);
								return (
									S && (d && e.refreshTask(d, !1), m && e.refreshTask(m, !1)),
									S && v(l.marker),
									y(
										this._dir_start.x,
										this._dir_start.y,
								...
								(t = (function(t, e) {
									...
									return {
										...
										_resize: function(i, n, r) {
											...
											r.left
												? ((i.start_date = e.dateFromPos(o.start + n)),
												  i.start_date ||
														(i.start_date = new Date(e.getState().min_date)))
												: ((i.end_date = e.dateFromPos(o.end + n)),
												  i.end_date ||
										...
										_drag_task_coords: function(t, i) {
											return {
												start: (i.obj_s_x =
													...
													i.obj_e_x || e.posFromDate(t.end_date))
											};
										},
										...
										on_mouse_move: function(t) {
											if (this.drag.start_drag) {
												...
												(Date.now() - this.drag.timestamp > 50 ||
													(this._is_number(r) &&
														this._is_number(o) &&
														this._mouse_position_change({ x: r, y: o }, i) >
															20)) &&
													this._start_dnd(t);
											}
											if (this.drag.mode) {
											...
											if (a.mode) {
												...
												if (this._handlers[a.mode]) {
													if (
														...
														a.mode == o.drag_mode.move
													) {
														var d = {};
														d[a.id] = r.copy(a);
														var h = this._find_max_shift(
															r.mixin(d, this.dragMultiple),
															c
														);
										...
										on_mouse_down: function(i, r) {
											if (2 != i.button || void 0 === i.button) {
												var a = t.$getConfig(),
													...
													s = null;
												if (
													(e.isTaskExists(o) && (s = e.getTask(o)),
													...
													if (c)
														if (
															...
															if (
																e.isSummaryTask(s) &&
																!a.drag_project &&
																c.mode != a.drag_mode.progress
															)
																return void this.clear_drag_state();
															c.id = o;
															var u = n.getRelativeEventPosition(
																i,
																e.$task_data
															);
															(c.start_x = u.x),
										...
										_fix_working_times: function(i, n) {
											var r = t.$getConfig();
											(n = n || { mode: r.drag_mode.move }).mode ==
											r.drag_mode.resize
												? n.left
										...
										_finalize_mouse_up: function(t, i, n, r) {
											...
											if (
												...
												e._init_task_timing(a),
													this.clear_drag_state(),
													e.updateTask(a.id),
													this._fireEvent('after_finish', n.mode, [
														o,
														n.mode,
														r
													]);
							...
							this._mouseDelegates.delegate(
								...
								this._mouseDelegates.delegate(
									...
									t.bind(function(t, i, n) {
										...
										return (
											n.parentNode &&
												o.getClassName(n.parentNode) &&
												(a =
													o.getClassName(n.parentNode).indexOf('_left') > -1
														? r.$target[0]
														: r.$source[0]),
											a && e.call(this, a, t),
											!1
			...
			t.exports = {
				...
				highlightPosition: function(t, e, i) {
					var a = (function(t, e) {
						...
						return (
							s > i.y + c - l.row_height && (s = i.y + c - l.row_height),
							(i.x = o),
							(i.y = s),
							i
						);
							...
							: (function(t, e, i) {
									var n = (function(t, e) {
										var i = e.$config.rowStore,
											...
											s = 0;
										if (
											(a && (o = a.offsetWidth), t.targetId !== i.$getRootId())
										) {
											var l = e.getItemTop(t.targetId),
												c = e.getItemHeight(t.targetId);
											if (
												((s = i.exists(t.targetId)
													? i.calculateItemLevel(i.getItem(t.targetId))
													: 0),
												t.prevSibling)
											)
												n.y = l;
		...
		function(t, e, i) {
			...
			t.exports = function(t, e, i, r, a) {
				...
				if (e !== a.$getRootId())
					o =
						i < 0.25
							? n.prevSiblingTarget(t, e, a)
							: !(i > 0.6) || (a.hasChild(e) && a.getItem(e).$open)
							? n.firstChildTarget(t, e, a)
							: n.nextSiblingTarget(t, e, a);
				else {
					var s = a.$getRootId();
					o =
						a.hasChild(s) && r >= 0
							? n.lastChildTarget(t, s, a)
							: n.firstChildTarget(t, s, a);
				}
				return o;
			};
		},
		function(t, e, i) {
			...
			function r(t, e, i, r, a) {
				...
				return r.exists(o)
					? r.calculateItemLevel(r.getItem(o)) === i
						? a
							? n.nextSiblingTarget(t, o, r)
							: n.prevSiblingTarget(t, o, r)
						: n.firstChildTarget(t, o, r)
					: null;
			}
			function a(t, e, i, n) {
				return r(t, e, i, n, !0);
			...
			t.exports = function(t, e, i, r, s, l) {
				...
				if (e !== s.$getRootId())
					i < 0.5
						? s.calculateItemLevel(s.getItem(e)) === l
							? (c = s.getPrevSibling(e)
									? n.nextSiblingTarget(t, s.getPrevSibling(e), s)
									: n.prevSiblingTarget(t, e, s))
							: (c = a(t, e, l, s)) && (c = o(t, e, l, s))
						: s.calculateItemLevel(s.getItem(e)) === l
						? (c = n.nextSiblingTarget(t, e, s))
						: (c = o(t, e, l, s)) && (c = a(t, e, l, s));
				else {
					var u = s.$getRootId(),
						d = s.getChildren(u);
				...
				init: function(t, e) {
					...
					if (e.$config.bind && t.getDatastore(e.$config.bind)) {
						...
						t.defined(e.$getConfig().dnd_sensitivity) &&
							(l.config.sensitivity = e.$getConfig().dnd_sensitivity),
							l.attachEvent(
								'onBeforeDragStart',
								t.bind(function(i, r) {
									var a = c(r);
									...
									return (
										!t.isReadonly(s) &&
										((l.config.initial_open_state = s.$open),
							...
							l.attachEvent(
								...
								t.bind(function(t, i) {
									...
									a &&
										((l.config.marker.style.opacity = 0.4),
								...
								t.bind(function(i, n) {
									...
									return (
										(a &&
											...
											(a = r.createDropTargetObject(l.config.drop_target)),
							...
							l.attachEvent(
								...
								t.bind(function() {
									...
									this.callEvent('onBeforeRowDragEnd', [
										...
										? (i.$drop_target = null)
										: (t.move(l.config.id, n.targetIndex, n.targetParent),
					...
					function u(t) {
						...
						return (
							i !== s.$getRootId() &&
								(r = (u - e.getItemTop(i)) / e.getItemHeight()),
							c
								? a(l.config.id, i, r, u, s, l.config.level)
								: o(l.config.id, i, r, u, s)
						);
					}
				}
			};
						...
						t.defined(e.$getConfig().dnd_sensitivity) &&
							...
							r.attachEvent(
								...
								t.bind(function(i, s) {
									...
									return (
										!t.isReadonly(u) &&
										((r.config.initial_open_state = u.$open),
										!!t.callEvent('onRowDragStart', [
											c,
							...
							(r.lastTaskOfLevel = function(t) {
								for (
									var e = null, i = o().getItems(), n = 0, r = i.length;
									n < r;
									n++
								)
									i[n].$level == t && (e = i[n]);
							...
							r.attachEvent(
								...
								t.bind(function(t, i) {
									...
									function h(t, e) {
										return (
											!l.isChildOf(f.id, e.id) &&
											(t.$level == e.$level || s.order_branch_free)
										);
									}
									if (
										(l.exists(d) ||
											((d = r.lastTaskOfLevel(
												s.order_branch_free ? c.$level : 0
											)) == r.config.id &&
												(d = null)),
										l.exists(d))
									) {
										var f = l.getItem(d);
										if (
											l.getIndexById(f.id) * s.row_height + s.row_height / 2 <
											u
										) {
											...
											if (p) {
												if (p.id == c.id)
													return s.order_branch_free &&
														l.isChildOf(c.id, f.id) &&
														1 == l.getChildren(f.id).length
														? void l.move(
																c.id,
																l.getBranchIndex(f.id) + 1,
																l.getParent(f.id)
														  )
														: void 0;
												f = p;
											...
											if (!l.hasChild(f.id))
												return (f.$open = !0), void l.move(c.id, -1, f.id);
											if (l.getIndexById(f.id) || s.row_height / 3 < u) return;
										}
										_ = l.getIndexById(f.id);
										for (
											var v = l.getIdByIndex(_ - 1), m = l.getItem(v), y = 1;
											(!m || m.id == f.id) && _ - y >= 0;

										)
											(v = l.getIdByIndex(_ - y)), (m = l.getItem(v)), y++;
										if (c.id == f.id) return;
										h(f, c) && c.id != f.id
											? l.move(c.id, 0, 0, f.id)
											: f.$level != c.$level - 1 || l.getChildren(f.id).length
											? m &&
											  h(m, c) &&
											  c.id != m.id &&
											  l.move(c.id, -1, l.getParent(m.id))
											: l.move(c.id, 0, f.id);
									}
									return !0;
								}, t)
		...
		function(t, e, i) {
			...
			t.exports = function(t) {
                ...
                'add' == g.name
								? (!e['hide'] ? (h =
										'<div ' +
										(b = t._waiAria.gridAddButtonAttrString(g)) +
										" class='gantt_add'></div>",f = '') : h='')
								: ((h = g.template ? g.template(e) : e[g.name]),
							...
							if (g.tree) {
								...
								(t.isSplitTask(e) && !t.config.open_split_tasks)
									? (v.push(s.grid_blank(e)), v.push(s.grid_file(e)))
									: (v.push(s.grid_open(e)), v.push(s.grid_folder(e)));
							}
						...
						w.className =
							'gantt_row' + p + ' gantt_row_' + t.getTaskType(e.type);
						...
						return (
							...
							i.$config.item_attribute &&
								w.setAttribute(i.$config.item_attribute, e.id),
						...
						get_points: function(i, n) {
							...
							if (u.from_start && u.to_start)
								this.point_to(l.left, c),
									d
										? (this.point_to(l.down, o), this.point_to(l.right, s))
										: (this.point_to(l.right, s), this.point_to(l.down, o)),
									this.point_to(l.right, c);
							else if (!u.from_start && u.to_start)
								if (((d = r.e_x > r.x + 2 * c), this.point_to(l.right, c), d))
									(s -= c), this.point_to(l.down, o), this.point_to(l.right, s);
								else {
									s -= 2 * c;
									var h = o > 0 ? 1 : -1;
					...
					render: function(n, r) {
						...
						h && (d += ' ' + h),
							...
							r.$config.link_attribute &&
								u.setAttribute(r.$config.link_attribute, n.id);
			...
			t.exports = function(t) {
				...
				function s(t, i) {
					e[t] &&
						e[t][i] &&
						e[t][i].parentNode &&
						e[t][i].parentNode.removeChild(e[t][i]);
				}
				function l(t) {
					var e,
						i = t.$getTemplates();
					return (
						void 0 !== i.task_cell_class
							? ((e = i.task_cell_class),
				...
				return {
					render: function(n, o, s) {
						...
						return (
							o.$config.rowStore.isSelected(n.id) && (k += ' gantt_selected'),
							(g.className = k),
							u.smart_rendering &&
							...
							o.$config.item_attribute &&
								g.setAttribute(o.$config.item_attribute, n.id),
							g
						);
					},
					update: function(t, n, r, u) {
						...
						if (d.show_task_cells) {
							...
							for (var m = g.start; m <= g.end; m++) {
								...
								!y && o(t, m)
									? s(t.id, m)
									: y && !y.parentNode && n.appendChild(y);
							}
						}
					},
					getRectangle: n
			...
			t.exports = function(t) {
				...
				return {
					render: function(i, n) {
						if (
							t.isSplitTask(i) &&
							((t.config.open_split_tasks && !i.$open) ||
								!t.config.open_split_tasks)
						) {
							for (
								var r = document.createElement('div'),
									a = t.getTaskPosition(i),
									o = t.getChildren(i.id),
									s = 0;
								s < o.length;
								s++
							) {
					...
					'keepDates' == n
						...
						? (function(e, i) {
								'end_date' == i
									...
									: ('start_date' != i && 'duration' != i) ||
									  (e.end_date = t.calculateEndDate(e));
						  })(e, i)
						: (function(e, i) {
								'start_date' == i || 'duration' == i
									? (e.end_date = t.calculateEndDate(e))
									: 'end_date' == i && (e.duration = t.calculateDuration(e));
						  })(e, i);
				};
			};
		},
					...
					a.attachEvent('onBeforeFocus', function(e) {
						...
						a.attachEvent('onKeyDown', function(e, r) {
							...
							switch (u) {
								case c.ENTER:
									t.isVisible()
										? (t.save(), r.preventDefault(), (d = !0))
										: s &&
										  !(r.ctrlKey || r.metaKey || r.shiftKey) &&
										  (i.startEdit(o.id, o.columnName),
										  r.preventDefault(),
										  (d = !0));
									break;
								case c.ESC:
								...
								case c.DELETE:
									s &&
										!t.isVisible() &&
										(i.startEdit(o.id, o.columnName), (d = !0));
									break;
								case c.TAB:
									if (t.isVisible()) {
								...
								default:
									if (t.isVisible()) d = !0;
										...
										f.alt ||
											(_ && a.getCommandHandler(e, 'taskCell')) ||
											(s &&
												!t.isVisible() &&
												(i.startEdit(o.id, o.columnName), (d = !0)));
									}
				...
				var r = {
					...
					createEditors: function(n) {
						function r(t, e) {
							...
							return (
								r.setAttribute('data-column-index', a),
								(r.style.cssText = [
									'top:' + i.top + 'px',
									'left:' + i.left + 'px',
									'width:' + i.width + 'px',
							...
							l = {
								...
								startEdit: function(e, i) {
									if ((this.isVisible() && this.save(), s.exists(e))) {
										...
										t.isReadonly(s.getItem(e))
											? this.callEvent('onEditPrevent', [n])
											: !1 !== this.callEvent('onBeforeEditStart', [n])
											? (this.show(n.id, n.columnName),
											  this.setValue(),
											  this.callEvent('onEditStart', [n]))
											: this.callEvent('onEditPrevent', [n]);
									}
								},
								isVisible: function() {
									return !(
										!this._editor ||
										!u.isChildOf(this._placeholder, document.body)
									);
								},
								show: function(t, i) {
									this.isVisible() && this.save();
									var a = { id: t, columnName: i },
								...
								_getItemValue: function() {
									...
									if (e) {
										...
										return (
											'auto' == e.map_to && (i = s.getItem(this._itemId)), i
										);
									}
								},
								isChanged: function() {
								...
								save: function() {
									if (
										...
										if (s.exists(e)) {
											...
											if (
												!1 !== this.callEvent('onBeforeSave', [l]) &&
								...
								moveRow: function(e) {
									for (
										var i = e > 0 ? t.getNext : t.getPrev,
											n = (i = t.bind(i, t))(this._itemId);
										t.isTaskExists(n) && t.isReadonly(t.getTask(n));
								...
								_initEvents: function() {
									...
									t.prototype._initEvents.apply(this, arguments),
										this._mouseDelegates.delegate(
											'click',
											'gantt_row',
											e.bind(function(t, e, i) {
												var r = this.$config.rowStore;
												if (!r) return !0;
												var a = n.locateAttribute(
													t,
													this.$config.item_attribute
												);
												return (
													a &&
														r.select(
															a.getAttribute(this.$config.item_attribute)
														),
													!1
												);
											}, this),
				...
				var i = {
					...
					column_drag_move: t.bind(function(i, r, a) {
						...
						if ((h < f && (h = f), o.keep_grid_width)) {
							...
							for (v = c + 1; v < l.length; v++)
								l[v].min_width
									? (_ -= l[v].min_width)
									: o.min_grid_column_width && (_ -= o.min_grid_column_width),
							...
							y + b > t.$container.offsetWidth &&
								(h = t.$container.offsetWidth - b);
						}
						return (
							(s.left = h - 1),
							(p = Math.abs(h - g)),
					...
					column_drag_end: t.bind(function(i, n, r) {
						for (
							...
							s += o[u].width;
						var d =
							c.min_width && i.config.left - s < c.min_width
								? c.min_width
								: i.config.left - s;
						if (
							(c.max_width && c.max_width < d && (d = c.max_width),
							!1 !== e.callEvent('onColumnResizeEnd', [l, c, d]) &&
								c.width != d)
						) {
					...
					function l(t, e, i) {
						...
						return (
							(function(t, e, i, n, a, o) {
								...
								for (
									var c = 1 * o.rightBorderWidth,
										u = r(o.rightBorderColor),
										d = 0,
										h = 0,
										f = 0,
										_ = 1;
							...
							if (
								...
								var h = (function(t, i, n, r) {
										...
										if (e.isIE) {
											...
											(-1 == h.indexOf('Windows NT 6.2') &&
												-1 == h.indexOf('Windows NT 6.1') &&
												-1 == h.indexOf('Windows NT 6.0')) ||
												(d = 2e4);
										}
										for (var f = 0; f < c.length; f++) {
											var _ = c[f];
											if (
												...
												for (
													var g = r,
														p = 0,
														v = Math.floor(d / i.row_height) * i.row_height,
														m = l;
													g > 0;
												...
												var n = e.firstChild,
													...
													o = {
														...
														rightBorderWidth: a
															...
															.replace('px', ''),
														bottomBorderColor: r.getPropertyValue(
															'border-bottom-color'
														),
														rightBorderColor: a.getPropertyValue(
															'border-right-color'
														)
													};
				...
				s = (function(t) {
					...
					function e(e, i, n, r) {
						...
						(this.$config = a.mixin(i, { scroll: 'x' })),
							(o._scrollHorizontalHandler = a.bind(
								o._scrollHorizontalHandler,
								o
							)),
							(o._scrollVerticalHandler = a.bind(o._scrollVerticalHandler, o)),
							(o._outerScrollVerticalHandler = a.bind(
								o._outerScrollVerticalHandler,
								o
							)),
							(o._outerScrollHorizontalHandler = a.bind(
								o._outerScrollHorizontalHandler,
								o
							)),
						...
						return (
							r.env.isIE && (s += 1),
							this._isHorizontal()
								? ((o.$config.height = s), (o.$parent.$config.height = s))
								: ((o.$config.width = s), (o.$parent.$config.width = s)),
						...
						(e.prototype._getScrollSize = function() {
							for (
								...
								if (
									...
									var u,
										d = t.$content.getSize();
									if (((u = d.hasOwnProperty(a) ? d[a] : d[o]), l))
										d[o] > d[s] &&
											d[o] > e &&
											u > d[s] - l + 2 &&
											((e = u + (n ? 0 : 2)), (i = d[s]));
				...
				s = (function(t) {
					...
					return (
						...
						(e.prototype._getResizePosition = function(t, e) {
							...
							return (
								-1 === c
									? ((l = a - i), (s = n - Math.abs(i)))
									: ((l = a - Math.abs(i)), (s = n + i)),
								{ size: i, newFrontSide: l, newBehindSide: s }
							);
						}),
						...
						(e.prototype._getGroupResizePosition = function(t, e) {
							...
							this._eachGroupItem(function(i) {
								...
								this._xMode
									? (n.x +=
											i._behind.$config.width - this._behind.$config.width)
									: (n.y +=
							...
							for (var o = 0; o < r.length; o++) {
								...
								void 0 === n
									? (n = r[o])
									: r[o].newBehindSide > n.newBehindSide && (n = r[o]);
							}
							return n;
						}),
		...
		function(t, e) {
			t.exports = function(t, e) {
				return (
					!!e &&
					(!(e.left > t.x_end || e.left + e.width < t.x) &&
						!(e.top > t.y_end || e.top + e.height < t.y))
				);
			};
		},
		function(t, e, i) {
			...
			t.exports = function(t) {
				...
				function l(l, c, u) {
					...
					var _ = c.filter;
					return (
						u && u.setAttribute(e.config().layer_attribute, !0),
						(o[l] = {
							render_item: function(e, i, a) {
								if (((i = i || u), !_ || _(e))) {
									...
									!l &&
										o &&
										o.$getConfig().smart_rendering &&
										(l = o.getViewPort());
									var h = null;
									!r(t) && f && l
										? n(l, f(e, o, t)) && (h = d.call(t, e, o, l))
										: (h = d.call(t, e, o, l)),
										this.append(e, h, i);
							...
							update_items: function(e, i) {
								...
								if (
									...
									for (var d = 0, _ = e.length; d < _; d++) {
										...
										p && p.parentNode
											? n(l, f(g, a, t))
												? (h && h.call(t, g, p, a, l), this.restore(g))
												: this.hide(g.id)
											: this.render_item(e[d], o, l);
									}
							...
							restore: function(t) {
								...
								e
									? e.parentNode || this.append(t, e, u)
									: this.render_item(t, u);
							},
					...
					createGroup: function(i, n, l, c) {
						var u = {
							...
							_add: function(i) {
								...
								for (
									var o = this.container(), s = this.tempCollection, l = 0;
									l < s.length;
									l++
								)
									if (
										...
										this.container() ||
											(i &&
												i.container &&
												a.isChildOf(i.container, document.body)))
									) {
										var u = i.container,
											d = i.id,
											h = i.topmost;
								...
								if (e) {
									'function' == typeof e && (e = { renderer: e }),
										void 0 === e.filter
											...
											: e.filter instanceof Array &&
											  (e.filter.push(l), (e.filter = s(e.filter))),
										e.container ||
									...
									e.requestUpdate = function() {
										t.config.smart_rendering &&
											!o(t) &&
											i.renderers[e.id] &&
											i.onUpdateRequest(i.renderers[e.id]);
									};
								}
			...
			function r(t, e) {
				if (t.view) {
					...
					'string' == typeof i && (i = e.$ui.getView(i)),
						i &&
							i.attachEvent &&
							i.attachEvent('onScroll', function() {
				...
				return function(e) {
								...
								for (var o = 0; o < a.length; o++)
									if (a[o] && i[a[o]])
										for (var s = i[a[o]], l = 0; l < s.length; l++)
											(s[l].root && !t.isChildOf(n, s[l].root)) ||
												r.push(s[l].handler);
							}
							n = n.parentNode;
						}
					...
					return {
						...
						callHandler: function(t, e, n, r) {
							...
							if (a)
								for (var o = 0; o < a.length; o++)
									((n || a[o].root) && a[o].root !== n) ||
										a[o].handler.apply(this, r);
						},
						onDoubleClick: l,
						onMouseMove: c,
						onContextMenu: a,
			...
			t.exports = {
				createFactory: function(t) {
					...
					function a(a, o, s, l) {
						...
						'resizer' != a ||
							s.mode ||
							(l.$config.cols ? (s.mode = 'x') : (s.mode = 'y')),
							'viewcell' != a ||
								'scrollbar' != s.view ||
								s.scroll ||
								(l.$config.cols ? (s.scroll = 'y') : (s.scroll = 'x')),
							(s = n.copy(s)).id || i[s.view] || (s.id = s.view),
							s.id && !s.css && (s.css = s.id + '_cell');
						var u = new c.create(o, s, this, t);
						return (
							c.configure && c.configure(u),
							r(u, l),
					...
					if (i) {
						...
						if (p.keyboard) {
							if (13 == e || 32 == e) {
								...
								r.getClassName(o).indexOf('gantt_popup_button') > -1 && o.click
									? o.click()
									: (a(i, !0), (n = !0));
							}
							27 == e && (a(i, !1), (n = !0));
					...
					var h = r.tagName
						...
						: (function(r, o, s) {
								...
								if (
									...
									s &&
										(h += l(
											c(r.cancel, t.locale.labels.message_cancel, 'Cancel'),
											'cancel',
											!1
										)),
									r.buttons)
						...
						default:
							return (function(e) {
								...
								return (
									...
									'bottom' == p.position && p.area.firstChild
										? p.area.insertBefore(i, p.area.firstChild)
										: p.area.appendChild(i),
									e.expire > 0 &&
										(p.timers[e.id] = window.setTimeout(function() {
											p.hide(e.id);
										}, e.expire)),
									(p.pull[e.id] = i),
									(i = null),
				...
				return (
					...
					t.attachEvent('onDestroy', function() {
						...
						(v = null),
							p.area &&
								p.area.parentNode &&
								p.area.parentNode.removeChild(p.area),
							(p = null);
					}),
					{
						alert: function() {
					...
					})(
						{
							...
							2: [
								function(t, i, n) {
									...
									(l.prototype.setScheduler = function(t) {
										...
										s.hasDevTools
											? ((l.prototype.invokeLater = function(t, e, i) {
										...
										function r(t) {
											var n = this.pop(),
												r = (function(t, n) {
													var r;
													if (
														(null != t && (r = t[n]), 'function' != typeof r)
													) {
														var a =
															'Object ' +
															i.classString(t) +
								...
								function(t, i, n) {
									...
									i.exports = function(i, n) {
										...
										var $ = (function() {
												try {
													...
													return (
														...
														function(t, e) {
															...
															return (
																i.initCustomEvent(t.toLowerCase(), !1, !0, e),
																!u.global.dispatchEvent(i)
															);
														}
													);
											...
											S = u.isNode
												...
												? function(t) {
														...
														return (
															!!i &&
															(i.apply(u.global, [].slice.call(arguments, 1)),
															!0)
														);
												  }
												: function() {
										...
										(i.config = function(t) {
											...
											(i.prototype._attachCancellationCallback = function(
												t
											) {}),
										...
										function R() {
											var t = this._boundTo;
											return void 0 !== t && t instanceof i
												? t.isFulfilled()
													? t.value()
													: void 0
												: t;
										...
										function H(t, e) {
											if (h(t)) {
												var i = this._trace;
												if (
													(void 0 !== i && e && (i = i._parent), void 0 !== i)
												)
										...
										function U(t, e, i, n) {
											...
											try {
												'function' == typeof e &&
													((r = !0), 'rejectionHandled' === t ? e(n) : e(i, n));
											} catch (t) {
												l.throwLater(t);
											}
											'unhandledRejection' === t
												? E(t, i, n) || r || W(i, 'Unhandled rejection ')
												: E(t, n);
										}
										function G(t) {
											var e;
									...
									e.exports = function(t) {
										...
										(t.prototype.return = t.prototype.thenReturn = function(i) {
											return (
												...
												this._then(e, void 0, void 0, { value: i }, void 0)
											);
										}),
											...
											(t.prototype.catchReturn = function(i) {
												if (arguments.length <= 1)
													return (
														i instanceof t && i.suppressUnhandledRejections(),
														this._then(void 0, e, void 0, { value: i }, void 0)
													);
												var n = arguments[1];
												return (
							...
							12: [
								function(t, e, i) {
									...
									for (
										...
										'function' == typeof Array.prototype[g[p]] &&
											(_.prototype[g[p]] = Array.prototype[g[p]]);
										...
										return (
											...
											(e.prototype._passThrough = function(t, e, i, n) {
												return 'function' != typeof t
													? this.then()
													: this._then(i, n, void 0, new l(this, e, t), void 0);
											}),
									...
									e.exports = function(e, i, n, r, a, o) {
										...
										c.inherits(f, a),
												...
												if (!this._isResolved()) {
													...
													if (i)
														this._promise._pushContext(),
															(t = d(this._generator.return).call(
																this._generator,
																void 0
															)),
														...
														(e.coroutine.returnSentinel = n),
															...
															this._promise._pushContext(),
															(t = d(this._generator.throw).call(
																this._generator,
																n
															)),
															this._promise._popContext();
											...
											(f.prototype._promiseFulfilled = function(t) {
												(this._yieldedPromise = null),
													this._promise._pushContext();
												var e = d(this._generator.next).call(
													this._generator,
													t
												);
											...
											(f.prototype._promiseRejected = function(t) {
												(this._yieldedPromise = null),
													...
													this._promise._pushContext();
												var e = d(this._generator.throw).call(
													this._generator,
													t
												);
												this._promise._popContext(), this._continue(e);
											...
											(e.coroutine = function(t, e) {
												...
												return function() {
													var e = t.apply(this, arguments),
														...
														o = a.promise();
													return (
														(a._generator = e), a._promiseFulfilled(void 0), o
													);
												};
											}),
									...
									e.exports = function(e, i, n, r, a, o) {
										...
										function h(t, e, i, n) {
											...
											(this._callback = null === r ? e : l.domainBind(r, e)),
												(this._preservedValues =
													n === a ? new Array(this.length()) : null),
												(this._limit = i),
												(this._inFlight = 0),
												(this._queue = []),
										...
										l.inherits(h, i),
											...
											(h.prototype._promiseFulfilled = function(t, i) {
												...
												if (i < 0) {
													...
													if (l >= 1 && this._inFlight >= l)
														return (n[i] = t), this._queue.push(i), !1;
													null !== s && (s[i] = t);
													var d = this._promise,
														h = this._callback,
														f = d._boundValue();
											...
											(h.prototype._filter = function(t, e) {
												for (
													var i = e.length, n = new Array(i), r = 0, a = 0;
													a < i;
													++a
												)
													t[a] && (n[r++] = e[a]);
										...
										(e.method = function(t) {
											...
											return function() {
												...
												var r = s(t).apply(this, arguments),
													o = n._popContext();
												return (
													a.checkForgottenReturns(r, o, 'Promise.method', n),
											...
											(e.attempt = e.try = function(t) {
												...
												var d = l._popContext();
												return (
													a.checkForgottenReturns(n, d, 'Promise.try', l),
										...
										return (
											...
											(D.prototype.spread = function(t) {
												return 'function' != typeof t
													...
													: this.all()._then(t, void 0, void 0, v, void 0);
											}),
											...
											(D.prototype._then = function(t, e, i, n, r) {
												...
												if (0 != (50397184 & u)) {
													...
													0 != (33554432 & u)
														...
														: ((v = l._settlePromiseLateCancellationObserver),
													...
													(this._promise0 = i),
														...
														'function' == typeof t &&
															(this._fulfillmentHandler0 =
																null === r ? t : c.domainBind(r, t)),
														'function' == typeof e &&
															(this._rejectionHandler0 =
																null === r ? e : c.domainBind(r, e));
												else {
													var o = 4 * a - 4;
													(this[o + 2] = i),
														(this[o + 3] = n),
											...
											(D.prototype._settlePromiseFromHandler = function(
												t,
												e,
												i,
												n
												...
												if (0 == (65536 & r)) {
													...
													n._pushContext(),
														e === v
															? i && 'number' == typeof i.length
																? (a = E(t).apply(this._boundValue(), i))
																: ((a = T).e = new _(
															...
															: (a = E(t).call(e, i));
													var o = n._popContext();
													0 == (65536 & (r = n._bitField)) &&
														(a === m
															? n._reject(i)
															: a === T
															? n._rejectCallback(a.e, !1)
															: (x.checkForgottenReturns(a, o, '', n, this),
											...
											(D.prototype._settlePromise = function(t, e, i, n) {
												...
												0 != (65536 & s)
													? (a && t._invokeInternalOnCancel(),
													  i instanceof $ && i.isFinallyHandler()
															? ((i.cancelPromise = t),
															  E(e).call(i, n) === T && t._reject(T.e))
															: e === r
															? t._fulfill(r.call(i))
															: i instanceof o
													...
													: 'function' == typeof e
													? a
														? (l && t._setAsyncGuaranteed(),
														  this._settlePromiseFromHandler(e, i, n, t))
														: e.call(i, n, t)
													: i instanceof o
													? i._isResolved() ||
													  (0 != (33554432 & s)
															? i._promiseFulfilled(n, t)
															: i._promiseRejected(n, t))
													: a &&
													  (l && t._setAsyncGuaranteed(),
													  0 != (33554432 & s) ? t._fulfill(n) : t._reject(n));
											}),
											(D.prototype._settlePromiseLateCancellationObserver = function(
												t
											) {
												var e = t.handler,
													i = t.promise,
												...
												'function' == typeof e
													? i instanceof D
														? this._settlePromiseFromHandler(e, n, r, i)
														: e.call(n, r, i)
													: i instanceof D && i._reject(r);
											}),
										...
										return (
											...
											(s.prototype._init = function t(i, a) {
												...
												if (s instanceof e) {
													...
													if (((this._values = s), 0 == (50397184 & l)))
														return (
											...
											(s.prototype._iterate = function(t) {
												...
												(this._length = i),
													(this._values = this.shouldCopyValues()
														...
														: this._values);
												for (
													var r = this._promise, a = !1, o = null, s = 0;
													s < i;
													++s
												) {
													var l = n(t[s], r);
											...
											(s.prototype._promiseFulfilled = function(t, e) {
												...
												return (
													i >= this._length && (this._resolve(this._values), !0)
												);
											}),
							...
							24: [
								function(t, e, i) {
									...
									e.exports = function(e, i) {
										...
										function p(t, e, i, n) {
											for (
												var a = r.inheritedDataKeys(t), o = [], s = 0;
												s < a.length;
												++s
											) {
												var l = a[s],
										...
										(e.promisify = function(t, e) {
											...
											if (_(t)) return t;
											var i =
													void 0 === (e = Object(e)).context ? n : e.context,
												a = !!e.multiArgs,
												o = (function(t, e, i) {
											...
											(e.promisifyAll = function(t, e) {
												...
												for (
													var s = r.inheritedDataKeys(t), l = 0;
													l < s.length;
													++l
												) {
													var u = t[s[l]];
													'constructor' !== s[l] &&
														r.isClass(u) &&
														(y(u.prototype, n, a, o, i), y(u, n, a, o, i));
												}
												return y(t, n, a, o, i);
											});
									};
									...
									e.exports = function(e, i, n, r) {
										...
										function d(t) {
											...
											return s(a)
												? ((i =
														a instanceof e
															? a._then(e.props, void 0, void 0, void 0, void 0)
															: new u(a).promise()),
											...
											(u.prototype._promiseFulfilled = function(t, e) {
												...
												if (i >= this._length) {
													...
													if (this._isMap)
														n = (function(t) {
															for (
																var e = new a(), i = (t.length / 2) | 0, n = 0;
																n < i;
																++n
															) {
																var r = t[i + n],
														...
														n = {};
														for (
															var r = this.length(), o = 0, s = this.length();
															o < s;
															++o
														)
								...
								function(t, e, i) {
									...
									e.exports = function(e, i, n, r) {
										...
										function s(t, s) {
											...
											for (
												var u = c._fulfill, d = c._reject, h = 0, f = t.length;
												h < f;
												++h
											) {
												var _ = t[h];
												(void 0 !== _ || h in t) &&
													e.cast(_)._then(u, d, void 0, c, null);
											}
											return c;
										}
										(e.race = function(t) {
									...
									e.exports = function(e, i, n, r, a, o) {
										...
										function u(t, i, n, r) {
											...
											(this._fn = null === o ? i : l.domainBind(o, i)),
												void 0 !== n &&
													(n = e.resolve(n))._attachCancellationCallback(this),
										...
										function f(t) {
											...
											return i instanceof e
												? ((this.array._currentCancellable = i),
												  i._then(_, void 0, void 0, this, void 0))
												: _.call(this, i);
										}
										function _(t) {
											var i,
												...
												(i =
													void 0 !== n._eachValues
														...
														: a.call(
																...
																this.index,
																this.length
														  )) instanceof e && (n._currentCancellable = i);
											var s = r._popContext();
											return (
												o.checkForgottenReturns(
													i,
													...
													return (function(t, a, o) {
														...
														var c = !0,
															u = n.tryCatch(a).call(
																...
																function(t) {
																	s &&
																		(s._rejectCallback(t, c, !0), (s = null));
																}
															);
														return (
															(c = !1),
															s &&
																u === r &&
																(s._rejectCallback(u.e, !0, !0), (s = null)),
															l
														);
													})(t, l, s);
												}
											...
											(e.prototype.timeout = function(t, e) {
												...
												return (
													n.cancellation()
														...
														: (i = this._then(c, u, void 0, l, void 0)),
													i
												);
											});
									};
											...
											(e.using = function() {
												...
												var k = e.all(b).then(function(t) {
														...
														var n = l ? a.apply(void 0, t) : a(t),
															r = w._popContext();
														return (
															o.checkForgottenReturns(n, r, 'Promise.using', w),
															n
														);
													}),
													w = k.lastly(function() {
							...
							36: [
								function(t, n, r) {
									...
									var R =
											void 0 !== e && '[object process]' === P(e).toLowerCase(),
										...
										(function() {
											...
											return (
												e.versions && e.versions.node
													...
													: e.version && (t = e.version.split('.').map(Number)),
												(0 === t[0] && t[1] > 10) || t[0] > 0
											);
										})()),
		...
		function(t, e) {
			t.exports = function(t) {
				...
				function i(i, n, r) {
					...
					t.config[i] &&
						e[r] != a[i] &&
						((n && o[r]) || ((o[r] = t.date.date_to_str(a[i])), (e[r] = a[i])));
				}
				return {
					...
					(i.prototype = {
						traceDragEvents: function(e, i) {
							...
							var o = r.bind(function(t) {
								...
								s = r.bind(function(n) {
									return (
										t.eventRemove(document.body, i.move, o),
					...
					str_to_date: function(e, i) {
						for (
							...
							switch (r[a]) {
								...
								case '%y':
									n +=
										'set[0]=temp[' + a + ']*1+(temp[' + a + ']>50?1900:2000);';
									break;
								case '%g':
								case '%G':
								case '%h':
								...
								case '%M':
									n +=
										'set[1]=locale.date.month_short_hash[temp[' + a + ']]||0;';
									break;
								case '%F':
									n +=
										'set[1]=locale.date.month_full_hash[temp[' + a + ']]||0;';
							}
						...
						var s = new Function(
							'date',
							'locale',
							'var set=[0,0,1,0,0,0]; ' + n + ' return new Date(' + o + ');'
						);
						return function(e) {
							return s(e, t.locale);
						};
						...
						return (
							e &&
								...
								('function' != typeof i &&
									('string' == typeof i
										? 'parse_date' === i
											? ((i = t.templates.parse_date),
											  t.defined(t.templates.xml_date) &&
													t.templates.parse_date !== t.templates.xml_date &&
													(i = t.templates.xml_date))
											: (i = t.defined(t.templates[i])
													? t.templates[i]
								...
								(a &&
									(u.onreadystatechange = function() {
										if (4 == u.readyState || (d && 3 == u.readyState)) {
											if (
												(200 != u.status || '' === u.responseText) &&
												!t.callEvent('onAjaxError', [u])
											)
												return;
											window.setTimeout(function() {
												'function' == typeof o &&
													o.apply(window, [{ xmlDoc: u, filePath: i }]),
													l(u),
													'function' == typeof o && ((o = null), (u = null));
											}, 0);
										}
									}),
								'GET' != e ||
				...
				(t.exports = function() {
					...
					r.registerProvider('global', function() {
						...
						return (
							t.$data &&
								t.$data.tasksStore &&
								(e.selected_task = t.$data.tasksStore.getSelectedId()),
							e
						);
					}),
					...
					var u = i(102);
					return (
						(t.dataProcessor = u.DEPRECATED_api),
